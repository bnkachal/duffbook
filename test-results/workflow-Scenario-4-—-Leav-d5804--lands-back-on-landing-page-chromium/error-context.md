...
- Name: workflow.spec.cjs >> Scenario 4 — Leave/reset clears session >> 4a — after leaving, user lands back on landing page
- Location: tests\e2e\workflow.spec.cjs:188:3
