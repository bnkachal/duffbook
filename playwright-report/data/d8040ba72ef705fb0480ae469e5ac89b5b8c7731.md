...
- Name: workflow.spec.cjs >> Scenario 1 — Admin creates a tournament >> 1e — no-players empty state shown before setup
- Location: tests\e2e\workflow.spec.cjs:79:3
...
Locator: getByTestId('no-players-state')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('no-players-state')

```

```yaml
- text: admin · 18 holes · code YD7HD
- button "Admin"
- button "Settings"
- text: Round 1 Hole 1 You –
- button "Round Flow where every group stands"
- button "Leaderboard tap to see everyone — this round 1 BK Brij Kachalia –"
- button "Your position $0"
- button "Group chat No messages yet"
- button "Home"
- button "Card"
- button "Games"
- button "Settle"
...
- button
- button
- text: The basics Tournament name
- textbox "Name your tournament"
- text: How many rounds is this trip?
- button "1"
- button "2"
- button "3"
- button "4+"
- text: You can add more later — this just gets the slots ready.
- button "Next" [disabled]
- button "Skip to full settings"
```
